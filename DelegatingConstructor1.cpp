/**
 * @file DelegatingConstructor1.cpp
 * @author Md. Yousuf Ali (yousuf.cse17@gmail.com)
 * @brief Delegating constructor type 1
 * @version 0.1
 * @date 2023-03-05
 * @since SunDay; 11:50 AM
...
public:
	Test(void):number1{0}, number2{0}, number3{0}, number4{0}{
		cout<<"Default constructor"<<endl;
	}
	Test(const int &number1):Test{}{
		this->number1 = number1;
		cout<<"Single paramiterize constructor"<<endl;
	}
	Test(const int &number1, const int &number2):Test{number1}{
		this->number2 = number2;
		cout<<"Double paramiterize constructor"<<endl;
	}
	Test(const int &number1, const int &number2, const int &number3):Test{number1, number2}{
