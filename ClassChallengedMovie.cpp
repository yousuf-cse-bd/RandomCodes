/**
 * @file ClassChallengedMovie.cpp
 * @author Md. Yousuf Ali (yousuf.cse17@gmail.com)
 * @brief Class typed vector class
 * @version 0.1
 * @date 2022-12-27
 * @since MonDay; 12:47 PM
...
class Movies{
private:
    vector <Movie> moviesList; /*Movie type data-type*/
public:
    Movies(){}/*Constructor*/
    ~Movies(){} /*Destructor*/
    void display(void)const{
    ...
    bool addMovie(const string name = "", const string rating = "", size_t watched = 0){
        for(const auto &movie : moviesList){ /*Efficient way fo & in for-each loop*/
